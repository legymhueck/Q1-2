 ...
 * binären Suchbaums. Alle Objekte im rechten Teilbaum sind größer als das
 * Inhaltsobjekt des binären Suchbaums. Diese Bedingung gilt (rekursiv) auch in
 * beiden Teilbäumen. <br />
...
public class BinarySearchTree<ContentType extends ComparableContent<ContentType>> {
	 ...
	 * 
	 * @return true, wenn der binäre Suchbaum leer ist, sonst false
	 * 
	 */
	 ...
	 * pContent uebereinstimmendes Objekt im geordneten binären Suchbau
	...
	/**
	 * Diese Anfrage liefert den linken Teilbaum des binären Suchbaumes. <br />
	...
	/**
	 * Diese Anfrage liefert den rechten Teilbaum des binären Suchbaumes. <br />
	 * Wenn er leer ist, wird null zurueckgegeben.
	 * 
	 ...
	 * pContent uebereinstimmendes Objekt im binären Suchbaum enthalten
	...
	/**
	 * Falls ein bezueglich der verwendeten Vergleichsmethode isEqual mit
	 * pContent uebereinstimmendes Objekt im binären Suchbaum enthalten ist,
